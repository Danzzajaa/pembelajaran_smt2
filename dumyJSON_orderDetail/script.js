...
function readData() {
  $.ajax({
    type: "get",
    url: "http://localhost:8080/tugas_smt_2/pelanggan/select.php",
    dataType: "json",
...
function selectP(id) {
  ...
  $.ajax({
    type: "POST",
    url: "http://localhost:8080/tugas_smt_2/pelanggan/cariData.php",
...
function ubahP() {
  ...
  $.ajax({
    type: "POST",
    url: "http://localhost:8080/tugas_smt_2/pelanggan/update.php",
    data: data,
...
function hapusP(idpelanggan) {
  ...
  if (tanya) {
    $.ajax({
      type: "POST",
      url: "http://localhost:8080/tugas_smt_2/pelanggan/delete.php",
      data: "idpelanggan=" + idpelanggan,
      success: function (response) {
        readData();
      },
...
$(document).ready(function () {
  ...
  $("#tambahP").click(function (e) {
    ...
    $.ajax({
      type: "POST",
      url: "http://localhost:8080/tugas_smt_2/pelanggan/insert.php",
      data: data,
      success: function (result) {
        var objResult = JSON.parse(result);
        $("#pesan").html(objResult.pesan);
    ...
    success: function (response) {
      ...
      $.each(response.products, function (key, val) {
        out += `<tr>
          ...
          <td>${val.title}</td>
          <td>${val.price}</td>
          <td><button class="btn btn-primary" onclick="cart(${val.id})">card</button></td>
        </tr>`;
      });
      tabel1.innerHTML = out;
    },
...
function cartP(idpelanggan) {
  $.ajax({
    type: "get",
    url: "http://localhost:8080/tugas_smt_2/order/select.php/?id="+idpelanggan,
    dataType: "JSON",
    success: function (response) {
...
function checkOut(idbarang,brg,hrg) {
  ...
  $.ajax({
    type: "post",
    url: "http://localhost:8080/tugas_smt_2/pelanggan/addtocard.php",
    data: data,
    success: function (response) {
